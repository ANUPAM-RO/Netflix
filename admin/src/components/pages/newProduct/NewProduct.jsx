    ...
    <div className="newProduct">
      ...
      <div className="newProductItemList">
        <form className="newProductForm">
          ...
          <div className="newProductItem">
            <label>Title</label>
            <input type="text" placeholder=" Jhon Key" name="title" onChange={handelChange} />
          </div>
          <div className="newProductItem">
          ...
          <div className="newProductItem">
            <label>Trailor</label>
            <input type="file" name="trailor" onChange={e=> setTraior(e.target.files[0])} />
          </div>
          <div className="newProductItem">
            <label>Video</label>
            <input type="file" video= "video" onChange={e=> setVideo(e.target.files[0])} />
          </div>
        </form>
      </div>
      ...
      {uploaded === 5 ? (
        ...
        <button className="newProductCreate" onClick={handleSubmit}>Create</button>
      ) : (
          <button className="newProductCreate" onClick={ handleUpload} >Upload</button>
      )}
